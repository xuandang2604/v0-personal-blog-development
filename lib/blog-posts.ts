...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Tìm hiểu về Socket programming trong Java, cách tạo kết nối client-server và truyền dữ liệu qua mạng.",
    date: "2025-10-15",
    category: "Java",
    readTime: "8 phút",
  },
  ...
  },
  {
    ...
    excerpt:
      "Hướng dẫn tạo server có khả năng xử lý nhiều client đồng thời sử dụng multithreading trong Java.",
    date: "2025-10-05",
    category: "Java",
    readTime: "12 phút",
  },
  {
    ...
    excerpt:
      "Khám phá cách gửi HTTP requests trong Java sử dụng HttpURLConnection và Java 11 HttpClient API.",
    date: "2025-10-20",
    category: "Java",
    readTime: "9 phút",
  },
  ...
  },
  {
    ...
    excerpt:
      "Giới thiệu về module net trong Node.js và cách tạo TCP server/client đơn giản.",
    date: "2025-10-15",
    category: "JavaScript",
    readTime: "7 phút",
  },
  {
    ...
    excerpt:
      "Hướng dẫn sử dụng WebSocket để tạo ứng dụng chat và các ứng dụng real-time khác với JavaScript.",
    date: "2025-10-08",
    category: "JavaScript",
    readTime: "11 phút",
  },
  {
    ...
    excerpt:
      "Xây dựng RESTful API hoàn chỉnh sử dụng Express.js, bao gồm routing, middleware và error handling.",
    date: "2025-10-01",
    category: "JavaScript",
    readTime: "13 phút",
  },
  {
    ...
    excerpt:
      "Khám phá Socket.IO library để xây dựng ứng dụng real-time với tính năng fallback và room management.",
    date: "2025-10-19",
    category: "JavaScript",
    readTime: "10 phút",
  },
