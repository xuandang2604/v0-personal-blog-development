      ...
      <section className="relative py-32 overflow-hidden bg-gradient-to-br from-primary/20 via-accent/10 to-background">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto text-balance leading-relaxed animate-fade-in-up">
            Khám phá các bài viết chuyên sâu về{" "}
            <span className="text-primary font-semibold">lập trình mạng</span>{" "}
            với Java, TypeScript và Node.js
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Tìm hiểu các công nghệ tôi đang sử dụng, các kỹ năng mà tôi đã tích
            lũy được qua các năm học đại học
          </p>
          <Link
            href="/expertise"
